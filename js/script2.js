...
const backdrop = document.querySelector('.body-main');
////////////////////////////
// ANIMATIOON
///////////////////////////
...
const cartTimeoutSpinner = function(spinner2) {
    setTimeout(function () {
        ...
        // backdrop.classList.add('backdrop-none')
        setTimeout( function () {
            spinner2.classList.add('full-hidden2');
            // backdrop.classList.remove('backdrop-none');
        }, 500)
    }, 0);
}
        ...
        del.addEventListener('click', function (e) {
           ...
           cartTimeoutSpinner(spinner2);
            setTimeout(function () {
                ...
                const cartEl = del.closest('.cart__body---main--list-store');
        ...
        <div class="cart__body---main--list-store-wrap">
            ...
            <div class="cart__body---main--list-store-wrap-prop">
                ...
                <div class="cart__body---main--list-store-wrap-prop-atr">
                    <div class="cart__body---main--list-store-wrap-prop-atr-price">$
